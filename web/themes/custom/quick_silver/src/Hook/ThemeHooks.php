...
namespace Drupal\quick_silver\Hook;
...
use Drupal\quick_silver\RenderCallbacks;
...
/**
 * Contains hook implementations for QuickSilver.
 */
final class ThemeHooks {
  ...
  public function themeSettingsFormAlter(array &$form): void {
    ...
    $message = $this->t("See <code>@path</code> to learn how to customize QuickSilver's fonts, colors, and components.", [
      '@path' => $this->themeList->getPath('quick_silver') . '/CUSTOMIZING.md',
    ]);
  ...
  public function preprocessHtml(array &$variables): void {
    ...
    $variables['quick_silver_path'] = $this->requestStack->getCurrentRequest()->getBasePath() . '/' . $this->themeList->getPath('quick_silver');
  }
