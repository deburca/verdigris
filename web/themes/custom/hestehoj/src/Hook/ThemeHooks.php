...
namespace Drupal\hestehoj\Hook;
...
use Drupal\hestehoj\RenderCallbacks;
...
/**
 * Contains hook implementations for Hestehoj.
 */
final class ThemeHooks {
  ...
  public function themeSettingsFormAlter(array &$form): void {
    ...
    $message = $this->t("See <code>@path</code> to learn how to customize Hestehoj's fonts, colors, and components.", [
      '@path' => $this->themeList->getPath('hestehoj') . '/CUSTOMIZING.md',
    ]);
  ...
  public function preprocessHtml(array &$variables): void {
    ...
    $variables['hestehoj_path'] = $this->requestStack->getCurrentRequest()->getBasePath() . '/' . $this->themeList->getPath('hestehoj');
  }
